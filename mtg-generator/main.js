...
/* harmony import */ var _data_soi_block__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../data/soi-block */ "./src/data/soi-block.ts");
/* harmony import */ var jszip__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! jszip */ "./node_modules/jszip/dist/jszip.js");
...
var AppComponent = /** @class */ (function () {
    ...
    AppComponent.prototype.getNewDecks = function () {
        ...
        var cards = _data_soi_block__WEBPACK_IMPORTED_MODULE_3__["SoiBlock"];
        this.shuffle(cards);
        var decks = [];
        var zip = new jszip__WEBPACK_IMPORTED_MODULE_4__();
        var _loop_1 = function (i) {
            var deck = new _deck__WEBPACK_IMPORTED_MODULE_1__["Deck"]();
            deck.colors = deckColors[i];
            deck.colors.sort();
            var onColor = cards.filter(function (c) {
            ...
            ['White', 'Blue', 'Black', 'Red', 'Green'].forEach(function (color) {
                ...
                if (count > 0) {
                    ...
                    proportion = Math.max(proportion, 7 / 17);
                    proportion = Math.min(proportion, 10 / 17);
                    deck.cards.push({
                        Name: basics[color],
            ...
            var names = deck.cards.reduce(function (acc, card) { return acc.concat(card.Name); }, []);
            cards = cards.filter(function (c) { return !names.includes(c.Name); });
            decks[i] = deck;
...
/***/ "./src/data/soi-block.ts":
/*!*******************************!*\
  !*** ./src/data/soi-block.ts ***!
  \*******************************/
/*! exports provided: SoiBlock */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "SoiBlock", function() { return SoiBlock; });
/* tslint:disable:quotemark */
var SoiBlock = [
    {
        "Name": "Noosegraf Mob",
        "OracleType": "Creature -- Zombie 0/0",
        "Mana": "4BB",
        "Rarity": "Rare",
        "Artist": "Seb McKinnon",
    ...
    },
    {
        ...
        "OracleType": "Creature -- Human Horror 1/1",
        "Mana": "1U",
        "Rarity": "Rare",
        "Artist": "Daarken",
        "Edition": "Eldritch Moon",
    ...
    },
    {
        ...
        "OracleType": "Creature -- Human Knight 4/4",
        "Mana": "3WW",
        "Rarity": "Rare",
    ...
    },
    {
        ...
        "OracleType": "Creature -- Human Rogue 3/2",
        "Mana": "2B",
        "Rarity": "Uncommon",
        "Artist": "Bud Cook",
        "Edition": "Shadows over Innistrad",
    ...
    },
    {
        ...
        "OracleType": "Creature -- Human Wizard 2/1",
        "Mana": "2U",
        "Rarity": "Uncommon",
    ...
    {
        "Name": "Altered Ego",
        "OracleType": "Creature -- Shapeshifter 0/0",
        "Mana": "X2UG",
        "Rarity": "Rare",
        "Artist": "Kev Walker",
        "Edition": "Shadows over Innistrad",
    ...
    },
    {
        ...
        "OracleType": "Creature -- Vampire Berserker 1/3",
        "Mana": "1R",
        "Rarity": "Uncommon",
        "Artist": "James Ryman",
        "Edition": "Shadows over Innistrad",
    ...
    },
    {
        ...
        "OracleType": "Creature -- Vampire 4/3",
        "Mana": "3RR",
        "Rarity": "Uncommon",
        "Artist": "Winona Nelson",
        "Edition": "Shadows over Innistrad",
    ...
    },
    {
        ...
        "OracleType": "Creature -- Human Cleric 3/1",
        "Mana": "3W",
        "Rarity": "Uncommon",
        "Artist": "Zoltan Boros",
        "Edition": "Shadows over Innistrad",
    ...
    {
        "Name": "Asylum Visitor",
        "OracleType": "Creature -- Vampire Wizard 3/1",
        "Mana": "1B",
        "Rarity": "Rare",
    ...
    {
        "Name": "Kessig Prowler",
        "OracleType": "Creature -- Werewolf Horror 2/1",
        "Mana": "G",
        "Rarity": "Uncommon",
    ...
    },
    {
        ...
        "OracleType": "Creature -- Human Shaman Werewolf 2/1",
        "Mana": "1R",
        "Rarity": "Uncommon",
        "Artist": "Winona Nelson",
        "Edition": "Shadows over Innistrad",
    ...
    },
    {
        ...
        "OracleType": "Creature -- Human Scout Werewolf 3/3",
        "Mana": "1RR",
        "Rarity": "Uncommon",
        "Artist": "Victor Adame Minguez",
        "Edition": "Shadows over Innistrad",
    ...
    },
    {
        ...
        "OracleType": "Creature -- Human Insect 3/2",
        "Mana": "3U",
        "Rarity": "Uncommon",
        "Artist": "Nils Hamm",
        "Edition": "Shadows over Innistrad",
